...
def example_search_return_number_of_hits(querystr):
    # limit: 0 means no ads, just a value of how many ads were found.
    json_response = _get_ads(querystr)
...
def example_search_return_number_of_hits2(querystr):
    # limit: 0 means no ads, just a value of how many ads were found.
    json_response = _get_ads2(querystr)
...
if __name__ == '__main__':
    ...
    #year = st.text_input("Sök på ett år: ")
    #yearstr = str(year)
    querystr = str(query)
